...
const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    provider: 'SMTP2GO',
    label: 'SMTP2GO',
    description: 'Transactional email (magic links, order confirmations, ticket delivery) via the SMTP2GO HTTP send API. The sender domain must be verified in your SMTP2GO account.',
    docsUrl: 'https://app.smtp2go.com/settings/apikeys/',
    keys: [
      { name: 'api_key', label: 'API key', placeholder: 'api-…   (Sending → API Keys → with “/email/send” permission)' },
      { name: 'from_email', label: 'From email', placeholder: 'tickets@droptix.co.uk — on a verified sender domain' },
